// src/pages/Marketplace.js (UPDATED CODE)
...
const MOCK_LISTINGS = [
    { id: 1, title: "Levi's 501 Jeans", description: "Barely worn jeans in perfect condition", list_price_cents: 5000, listed_on: '2025-10-10', condition: 'LikeNew', category: 'Bottoms', image: '' }, 
    ...
    { id: 4, title: "Nike Air Max Shoes", description: "Clean and comfy", list_price_cents: 7800, listed_on: '2025-10-23', condition: 'Good', category: 'Footwear', image: '' }, 
...
function Marketplace() {
   const [listings, /* setListings */] = useState(MOCK_LISTINGS);
    const [currentFilters, setCurrentFilters] = useState({
        search: '',
        category: '',
        condition: '', // <-- Added condition state
        priceRange: [0, 50000], 
    });
