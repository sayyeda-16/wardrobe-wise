...
from app_user.views import TopSellingCategories, SalesHistory, TargetUserCohorts, InventoryReport
from app_user.views import CurrentUser
from app_user.views import MeView
from app_user.views import ItemListCreateView, ItemRetrieveUpdateDestroyView, SeasonalWardrobeSuggestionsView, ItemConditionSummaryView
...
from app_user.views import ContactSellerView 
...
urlpatterns = [
    ...
    path('api/wardrobe/condition-summary/', ItemConditionSummaryView.as_view(), name='condition-summary'),
    ...
    path('api/marketplace/checkout/', ContactSellerView.as_view(), name='checkout_intent'),
     # # 3. Item Edit/Delete
    #path('api/items/<int:item_id>/', ItemRetrieveUpdateDestroyView.as_view(), name='item-detail'),
] + router.urls